...
public class Versioned {
    private java.util.Map<Integer, UnitAction> inner;
    public java.util.Map<Integer, UnitAction> getInner() { return inner; }
    public void setInner(java.util.Map<Integer, UnitAction> inner) { this.inner = inner; }
    public Versioned() {}
    public Versioned(java.util.Map<Integer, UnitAction> inner) {
        this.inner = inner;
    }
    ...
    public void writeTo(java.io.OutputStream stream) throws java.io.IOException {
        ...
        for (java.util.Map.Entry<Integer, UnitAction> innerEntry : inner.entrySet()) {
